...
/**
 * <p>Hash passwords for storage, and test passwords against password tokens.</p>
...
public final class PasswordAuthenticator {
	 ...
	 */
	public static final String ID = "$21$";
	...
	private static final Pattern layout = Pattern.compile("\\$21\\$(\\d\\d?)\\$(.{43})");
	...
	/**
	 * Default constructor with default cost
	 */
